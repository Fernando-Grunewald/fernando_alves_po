...
# um sistema. Essa hierarquia deve permitir que um cliente possa 
# *realizar login e efetuar compras*, com um  
# *comportamento adicional reservado apenas a clientes VIP*.
#  Sua 
# implementação deve demonstrar o uso de herança e reutilização de código entre as classes. 
# *Os métodos devem exibir mensagens descritivas que evidenciem as ações executadas*
# e a classe que as realiza. No módulo de execução, o programa deve interagir com o usuário por 
